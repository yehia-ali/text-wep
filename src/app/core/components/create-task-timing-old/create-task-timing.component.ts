...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, InputLabelComponent, InputErrorComponent, MatButtonModule, MatInputModule, NgSelectModule, FormsModule, TranslateModule, RecordComponent, OwlDateTimeModule],
