...
@Component({
  ...
  template: `
    ...
    <div class="custom-year-picker-container" [class]="classes" #yearPickerContainer>
      <div class="year-picker-button" (click)="toggleDropdown($event)">
...
export class CustomYearPickerComponent implements OnInit {
  ...
  @ViewChild('yearPickerContainer', { static: true }) yearPickerContainer!: ElementRef;
  ...
  ngOnInit(): void {
    ...
    document.addEventListener('click', (event) => {
      ...
      if (this.yearPickerContainer && !this.yearPickerContainer.nativeElement.contains(target)) {
  ...
  private updateYearRange(year: number): void {
    console.log('Updating year range for year:', year);
    ...
    console.log('Emitting onChange with year:', year);
    this.onChange.emit(year);
    console.log('Emitting onYearChange with year:', year);
